...
import { User, Mail, Briefcase, Building2, Shield, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 p-8 font-sans">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Nouvel Employé</h1>
          <p className="text-slate-500 mt-1">Créez le dossier d&apos;un nouveau collaborateur.</p>
        </div>
